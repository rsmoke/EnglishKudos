            ...
            <form action="index.php" method="post">
              <div id="userInfo" >
                <div class="row-fluid clearfix">
                  ...
                  <hr>
                  <label for="kudoType">What category is this?</label>
                  <label class="radio">
                  ...
                  <div class="form-group">
                    <label for="kudoTitle">Title</label>
                    <input class="form-control input-sm" type="text" tabindex="180" required name="kudoTitle" />
                    <label for="kudoDesc">Description</label>
                    <textarea class="form-control input-sm" rows=5  tabindex="182" name="kudoDesc" > </textarea>
                  </div>
                </div>
              </div>
